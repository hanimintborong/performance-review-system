      ...
      <Portal>
        ...
        <Dialog.Positioner>
          <Dialog.Content borderRadius="12px" maxW="440px">
            <Dialog.Header p="22px 26px 6px"><Dialog.Title fontSize="15px">Add employee</Dialog.Title></Dialog.Header>
            <Dialog.Body p="10px 26px">
              <Flex direction="column" gap="10px">
                <Field label="Full name">
                  <Input size="sm" px="12px" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} placeholder="e.g. Aisha Tan" />
                </Field>
                <Field label="Work email">
                  <Input size="sm" px="12px" type="email" value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} placeholder="name@borong.com" />
                </Field>
                <Field label="Job title">
                  <Input size="sm" px="12px" value={form.jobTitle} onChange={(e) => setForm({ ...form, jobTitle: e.target.value })} placeholder="e.g. Revenue Executive" />
                </Field>
