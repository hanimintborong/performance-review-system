...
export const usersColumns: DataTableColumn<SystemUserRow>[] = [
  {
    key: "employee",
    label: "Employee",
    width: "1.6fr",
  ...
  { key: "email", label: "Email", width: "1.4fr", render: (user) => user.email },
  { key: "role", label: "Role", width: "1fr", render: (user) => ROLE_META[user.role].label },
  {
    key: "status",
    label: "Status",
    width: "110px",
  ...
  { key: "invitedAt", label: "Invited", width: "110px", render: (user) => formatDate(user.invitedAt.slice(0, 10)) },
];
