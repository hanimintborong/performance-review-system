...
export const mockNotificationHistory: NotificationHistoryEntry[] = [
  ...
  { historyId: "HIST005", ruleId: "RULE004", recipientName: "Nadia Roslan", type: "upcoming_deadline", channel: "email", sentAt: "2026-07-21 09:00", delivered: true },
  { historyId: "HIST006", ruleId: "RULE004", recipientName: "Daniel Wong", type: "upcoming_deadline", channel: "email", sentAt: "2026-07-21 09:00", delivered: false },
